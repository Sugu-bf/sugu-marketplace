    ...
    <Container as="section" className="py-4 animate-fade-slide-up">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {slides.map((slide, index) => {
          const href = slide.href || "/search";
          return (
            <Link
              key={slide.id}
              href={href}
              className="group relative aspect-[2.2/1] overflow-hidden rounded-2xl shadow-md transition-all duration-500 hover:shadow-xl hover:scale-[1.02] block"
              style={{
