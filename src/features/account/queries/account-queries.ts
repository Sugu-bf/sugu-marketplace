...
const FAQ_ITEMS: FaqItem[] = [
  ...
  { id: 5, question: "Comment contacter le service client ?", answer: "Vous pouvez nous joindre par téléphone au +226 64528958, par WhatsApp, ou via le chat en ligne.", category: "Support" },
...
export async function queryOrders(params?: {
  ...
  try {
    ...
    handleAuthError(error);
    // Any other error (500, schema mismatch, network) → rethrow so Next.js
    // error boundary activates instead of showing a misleading empty state.
    throw error;
  }
}
