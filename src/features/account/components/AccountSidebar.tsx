...
const MAIN_NAV: NavItem[] = [
  ...
  { label: "Mes paiements", href: "/account/payments", icon: <CreditCard size={18} /> },
  ...
  { label: "Mes coupons", href: "/account/coupons", icon: <Tag size={18} /> },
];
...
const SECONDARY_NAV: NavItem[] = [
  ...
  { label: "Se déconnecter", href: "/logout", icon: <LogOut size={18} />, variant: "danger" },
];
