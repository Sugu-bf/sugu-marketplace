...
/**
 * Home page content — Server Component with ISR + parallel data fetching.
 *
 * Extracted into its own module so page.tsx can conditionally render
 * either this or the Coming Soon page based on an env flag.
 *
